...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdp-132) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; As expected, the function call returns #true.
